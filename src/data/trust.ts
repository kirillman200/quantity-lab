...
export const trustPages: TrustPage[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Optional analytics', paragraphs: ['The site has its own Google Analytics 4 property. Analytics does not load until you select Allow analytics, and Global Privacy Control keeps it off. When allowed, it receives a query-free page path, page title, referrer origin, and ordinary device or browser information. Calculator values, saved projects, and share-link queries are excluded. You can reopen the choice with the Analytics choices button. AdSense reporting remains a separate service.'] },
    ],
  },
  {
